...
#----------------------------------------------------------------------------
            ...
            # $NVCC was set above.
            CC='$NVCC'
            CFLAGS="--relocatable-device-code=true -gencode=arch=compute_20,code=sm_20 -I$TMW_ROOT/toolbox/distcomp/gpu/extern/include --compiler-options=-ansi,-D_GNU_SOURCE,-fexceptions,-fPIC,-fno-omit-frame-pointer,-pthread"
...
#
            ...
            # $NVCC was set above.
            CXX='$NVCC'
            CXXFLAGS="--relocatable-device-code=true -gencode=arch=compute_20,code=sm_20 -I$TMW_ROOT/toolbox/distcomp/gpu/extern/include --compiler-options=-ansi,-D_GNU_SOURCE,-fPIC,-fno-omit-frame-pointer,-pthread"
