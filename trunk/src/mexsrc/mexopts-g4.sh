...
#----------------------------------------------------------------------------
            ...
            # CkeyLinkerVersion:
            G4LIBS=`geant4-config --libs`
            G4FLAGS=`geant4-config --cflags`
            CC='g++ -w'
            CFLAGS='-ansi -D_GNU_SOURCE -DLUCRETIA_G4TRACK'
...
#
            ...
            # C++keyLinkerVersion:  
            CXX='g++'
            CXXFLAGS='-ansi -D_GNU_SOURCE -DLUCRETIA_G4TRACK'
            CXXFLAGS="$CXXFLAGS -fPIC -fno-omit-frame-pointer -pthread"
            CXXFLAGS="$CXXFLAGS $G4FLAGS"
