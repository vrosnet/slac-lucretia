...
%   Isext  = ATF2 sextupole currents (amps) [5 element array]
...
%   energy = beam energy (GeV)
%   KL     = sextupole KLs (1/m^2; positive means "SF") [5 element array]
%   fflag  = (optional) if present and nonzero, fudge factors will be used
%
...
% there are 5 ATF2 sextupoles, each with its own MMS data:
...
% courtesy of Cherrill Spencer (SLAC)

sI=[ ...
%  SF6    SF5    SD4    SF1      SD0
   0    , 0    , 0    , 0      , 0      ; ...
   0.398, 0.396, 0.397, 2.9621 , 2.9615 ; ...
   0.829, 0.829, 0.83 , 5.95714, 5.9561 ; ...
   1.399, 1.399, 1.399, 8.9525 , 8.9508 ; ...
   1.832, 1.832, 1.832,11.96446,11.96224; ...
   2.301, 2.302, 2.302, 0      , 0      ; ...
   4.972, 4.97 , 4.971, 0      , 0      ; ...
   7.443, 7.442, 7.443, 0      , 0      ; ...
   9.912, 9.909, 9.911, 0      , 0      ; ...
  15.069,15.065,15.068, 0      , 0      ; ...
  19.962,19.962,19.962, 0      , 0      ; ...
  24.962,24.961,24.962, 0      , 0      ; ...
  30.055,30.055,30.055, 0      , 0      ; ...
  35.066,35.066,35.066, 0      , 0      ; ...
  39.908,39.912,39.91 , 0      , 0      ; ...
  45.059,45.063,45.061, 0      , 0      ; ...
  49.999,50.004,50.002, 0      , 0      ; ...
];

sGL=[ ...
%   SF6         SF5         SD4        SF1     SD0
    0        ,  0        ,  0        , 0      , 0      ; ...
    2.2498363,  1.9905675,  2.0174219, 8.67672, 8.59829; ...
    3.1659143,  2.9116955,  2.9416777,17.585  ,17.47928; ...
    4.3772233,  4.126823 ,  4.1611131,26.46082,26.33882; ...
    5.292689 ,  5.0464729,  5.0835106,35.31407,35.13744; ...
    6.2995431,  6.0563734,  6.096839 , 0      , 0      ; ...
   12.1380489, 11.896674 , 11.9431827, 0      , 0      ; ...
   17.5544078, 17.3217305, 17.3880054, 0      , 0      ; ...
   23.0261077, 22.7888383, 22.8818389, 0      , 0      ; ...
   34.5769838, 34.3304156, 34.4413399, 0      , 0      ; ...
   45.6399439, 45.3629794, 45.5144949, 0      , 0      ; ...
   57.0404355, 56.6435797, 56.8469279, 0      , 0      ; ...
   68.6272702, 68.0544545, 68.3276361, 0      , 0      ; ...
   79.9906013, 79.2441692, 79.5503455, 0      , 0      ; ...
   90.9077093, 90.0244698, 90.3472626, 0      , 0      ; ...
  102.4637655,101.4447267,101.7951883, 0      , 0      ; ...
  113.4777391,112.3449583,112.7209785, 0      , 0      ; ...
];
